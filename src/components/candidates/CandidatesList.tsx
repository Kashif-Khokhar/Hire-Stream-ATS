                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto">
                    <div className="relative group w-full sm:w-auto">
                        ...
                        <input
                            ...
                            className="bg-white border border-slate-200/60 rounded-2xl py-2.5 pl-12 pr-4 text-sm focus:outline-none focus:ring-4 focus:ring-brand-500/10 focus:border-brand-500 transition-all w-full sm:w-80 font-medium"
                        />
                    </div>
                    <button className="flex items-center justify-center gap-2 border border-slate-200/60 bg-white hover:bg-slate-50 px-5 py-2.5 rounded-2xl text-xs font-black text-slate-600 transition-all shadow-sm uppercase tracking-widest italic w-full sm:w-auto">
