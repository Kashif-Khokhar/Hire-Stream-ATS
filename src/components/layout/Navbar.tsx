...
export const Navbar: React.FC<NavbarProps> = ({ onMenuClick }) => {
    return (
        <header className="h-16 md:h-20 glass bg-white/80 sticky top-0 z-30 flex items-center justify-between px-4 md:px-10 border-b border-slate-200/40">
            ...
            <div className="flex items-center gap-4 md:gap-8">
                ...
                <div className="flex items-center gap-2 md:gap-3">
                    <button className="p-2 md:p-3 text-slate-500 hover:text-brand-600 hover:bg-white rounded-xl transition-all relative border border-transparent hover:border-brand-100 hover:shadow-spotlight">
                    ...
                    <div className="h-6 w-px bg-slate-200/60 mx-2 hidden md:block"></div>
                    ...
                    <button className="flex items-center gap-4 p-1.5 hover:bg-white rounded-2xl transition-all border border-transparent hover:border-slate-200/50 hover:shadow-premium group">
                        ...
                        <div className="w-9 h-9 md:w-11 md:h-11 bg-slate-100 rounded-xl flex items-center justify-center border border-slate-200 group-hover:border-brand-300 group-hover:rotate-3 transition-all relative overflow-hidden">
                            <User className="text-slate-600 w-5 h-5 md:w-5.5 md:h-5.5 group-hover:text-brand-600 transition-colors relative z-10" />
